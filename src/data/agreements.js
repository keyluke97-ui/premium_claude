const AGREEMENTS = [
  {
    ...
    clauses: [
      ...
      },
      {
        num: '제11조',
        title: '진행 기한 및 미제출',
        text: '크리에이터는 신청 완료 후 2개월 이내 방문을 완료하며, 퇴실일로부터 14일 이내 콘텐츠를 업로드합니다. 단, 신청 후 2개월 이내 크리에이터 모집이 완료되지 않은 경우, 캠지기가 설정한 목표 모집 인원을 충족하기 위해 크리에이터 입실 가능 기한 및 팔로워 쿠폰 유효 기한이 일괄 연장될 수 있습니다. 미제출 시 동일 등급 대체 매칭을 진행하며 숙박권 금전 보상은 불가합니다.',
      },
      {
        num: '제12조',
        title: '분쟁',
